return {
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>ff', require('luk.plugins.custom.find_directories').find_dirs, { desc = '[F]ind [F]olders' })
      ...
      vim.keymap.set('n', '<leader>sg', require 'luk.plugins.custom.multi-ripgrep', { desc = '[S]earch [G]rep' })
